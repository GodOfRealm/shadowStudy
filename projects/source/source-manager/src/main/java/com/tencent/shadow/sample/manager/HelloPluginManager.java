 ...
 * description :
 */
public class HelloPluginManager  extends FastPluginManager {

    private ExecutorService executorService = Executors.newSingleThreadExecutor();

    private Context mCurrentContext;

    public HelloPluginManager(Context context) {
        super(context);
    ...
    protected String getPluginProcessServiceName(String partKey) {
        return "com.demo.source.host.HelloProcessPPS";
    }
