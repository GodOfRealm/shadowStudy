...
package com.mobile.emulatormodule.mame.input;
...
public interface IController {
	...
	final public static int UP_LEFT_VALUE = UP_VALUE | LEFT_VALUE;
	final public static int UP_RIGHT_VALUE = UP_VALUE | RIGHT_VALUE;
	final public static int DOWN_LEFT_VALUE = DOWN_VALUE | LEFT_VALUE;
	final public static int DOWN_RIGHT_VALUE = DOWN_VALUE | RIGHT_VALUE;
	...
	final public static int MAME_A_VALUE = B_VALUE;
	final public static int MAME_B_VALUE = X_VALUE;
	final public static int MAME_C_VALUE = A_VALUE;
	final public static int MAME_D_VALUE = Y_VALUE;
